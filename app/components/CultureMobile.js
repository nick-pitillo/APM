  ...
  return (
    <section className="block md:hidden w-full bg-white py-10 font-montserrat">
      <div className="mx-auto max-w-[812px] px-4">
        {/* Heading */}
        <h2 className="text-center text-[clamp(0.9rem,1.4vw,1.45rem)]   font-medium text-black mb-14">
          The APM Culture
        </h2>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="mt-2 text-[clamp(0.9rem,1.4vw,1.45rem)]s font-light text-black leading-snug mx-auto max-w-[600px] px-14">
