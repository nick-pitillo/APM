...
const CareersHero = () => {
  return (
    ...
    <section className="mt-10 sm:mt-4.5 relative flex h-screen flex-col items-center justify-center font-montserrat text-white rounded-2xl px-2">
