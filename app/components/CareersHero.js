...
const CareersHero = () => {
  return (
    ...
    <section className="relative flex h-screen flex-col items-center justify-center font-montserrat text-white rounded-2xl px-2">
      
    {/* 1. Background Images - Desktop and Mobile */}
    {/* Desktop Background Image - hidden on mobile */}
    <Image
      src="/Career/image-62.jpg" 
      alt="A description of the background image for accessibility"
      fill
      className="object-cover hidden md:block rounded-2xl px-2" // Hidden on mobile, shown on md and up
      priority
      sizes="100vw"
    />
    ...
    <Image
      src="/Career/image-20.jpg" 
      alt="A description of the mobile background image for accessibility"
      fill
      className="object-cover block md:hidden rounded-2xl px-2" // Shown on mobile, hidden on md and up
      priority
      sizes="100vw"
    />
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        {/* Main Title */}
        <h1 className="text-[clamp(0.9rem,1.4vw,1.45rem)] font-medium tracking-wide">
          Join the APM Family
        </h1>
        
        {/* Subtitle */}
        <p className="mt-2 max-w-3xl text-[clamp(0.9rem,1.4vw,1.45rem)] font-light leading-snug">
        ...
        <a 
          ...
          className="mt-10 rounded-2xl bg-[#16469D] px-6 py-4 text-[clamp(0.9rem,1.4vw,1.45rem)] font-normal transition-colors hover:bg-blue-800"
        >
      ...
      <div className="absolute bottom-10 z-10 flex flex-col items-center gap-2">
        <p className="text-[clamp(0.9rem,1.4vw,1.45rem)] font-light">Scroll</p>
