...
export default function CareersPage() {
  return (
    <main>
      ...
      <FeaturedLogos />
      <section className="w-full bg-white mx-auto mt-3 sm:mt-4 md:mt-4 lg:mt-20 xl:mt-20">
    ...
    <section className="w-full bg-white mt-3 sm:mt-4 md:mt-4 lg:mt-20 xl:mt-20 px-8">
    ...
    <section className="w-full bg-white mt-3 sm:mt-4 md:mt-4 lg:mt-20 xl:mt-20">
...
<section className="w-full bg-white font-montserrat hidden md:block mt-20 mb-20">
...
{/* Mobile / Small screen */}
<section className="w-full bg-white mt-6 sm:mt-4 md:mt-4 lg:mt-20 xl:mt-20 px-4 font-montserrat block md:hidden">
  <h2 className="text-center text-[clamp(0.9rem,1.4vw,1.45rem)]  font-medium text-black mb-6">
    Join Us
  </h2>

  <p className="mx-auto max-w-[837px] text-center sm:text-left md:text-left lg:text-left xl:text-left text-[clamp(0.9rem,1.4vw,1.45rem)] font-light leading-relaxed text-black">
    APM Restaurant Group is seeking talented and experienced hospitality
    and culinary professionals to join our expanding team.
    <br />
    <br />
